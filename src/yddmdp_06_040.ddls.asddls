@AbapCatalog.sqlViewName: 'YVMDP_06_040'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Units of Measurement'
define view YDDMDP_06_040
  as select from    t006  as units_of_measurement
    left outer join t006a as units_of_measurement_texts 
    on units_of_measurement.msehi = units_of_measurement_texts.msehi
{
  key units_of_measurement.mandt       as client,
  @EndUserText.label: 'int. UOM'
  @EndUserText.quickInfo: 'internal Unit of Measurement'
  key units_of_measurement.msehi       as unit_of_measurement,
